...
const Carousel = () => {
  ...
  return (
    <div className='max-w-[1240px] mx-auto px-4 py-16 relative flex justify-center items-center' name='pictures'>
      ...
      {sliderData.map((item, index) => (
        <div className={index === slide ? 'opacity-100 duration-500' : 'opacity-0'}>
